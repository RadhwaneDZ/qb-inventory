...
QBCore.Commands.Add("giveitem", "Give An Item (Admin Only)", {{name="id", help="Player ID"},{name="item", help="Name of the item (not a label)"}, {name="amount", help="Amount of items"}}, true, function(source, args)
	...
	if Player ~= nil then
		...
		TriggerEvent("qb-log:server:CreateLog", "default", "admin give item", "red", "**".. source .. "** give item to (citizenid: *"..Player.PlayerData.citizenid.."* | " ..GetPlayerName(tonumber(args[1])).." "..amount.." "..itemData["name"].. " ")
